...
def view_test_history():
    ...
    tree = ttk.Treeview(win, columns=("Name", "Date", "Test Type", "Result"), show="headings", selectmode="browse")
    ...
    for i, r in enumerate(results):
        ...
        tree.insert("", "end", iid=str(i), values=(name, r["date"], r["test_type"], r["result"]))
    ...
    # ✅ ปุ่มวางด้านล่าง
    delete_button = tk.Button(win, text="Delete", command=delete_selected_result, bg="red", fg="white", font=("Arial", 11))
