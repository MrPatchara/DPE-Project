...
def view_test_history():
    ...
    delete_button = tk.Button(win, text="Delete Selected", command=delete_selected_result, bg="red", fg="white", font=("Arial", 11))
    delete_button.pack(pady=5)

    view_button = tk.Button(win, text="View Selected", command=view_selected_result, bg="blue", fg="white", font=("Arial", 11))
