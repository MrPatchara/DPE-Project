...
# ✅ สร้าง Dropdown สำหรับเลือกโปรโตคอล
...
# ✅ สร้าง Frame สำหรับตั้งค่า Warning
warning_frame = tk.Frame(root)
warning_frame.pack(pady=5)

warning_label = tk.Label(warning_frame, text="Max Warnings (0 = Instant Disqualify):")
warning_label.pack(side="left")

warning_var = tk.IntVar(value=max_warnings)  # ✅ ใช้ IntVar สำหรับผูกกับ Entry
warning_entry = tk.Entry(warning_frame, textvariable=warning_var, width=5)
warning_entry.pack(side="left", padx=5)

# ✅ ปุ่มสำหรับบันทึกการตั้งค่า
set_warning_button = tk.Button(warning_frame, text="Set Warnings", command=set_max_warnings)
